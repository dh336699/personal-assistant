...
const Pinpa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  get MutationType() {
    return MutationType;
  },
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "营养热量计算器",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/caculator/result/result",
    style: {
      navigationBarTitleText: "营养热量计算结果",
      enablePullDownRefresh: false
    }
  },
  {
    ...
    style: {
      navigationBarTitleText: "金店品牌",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/brand/price",
    style: {
      navigationBarTitleText: "最新价格",
      enablePullDownRefresh: false
    }
  },
  {
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "172.26.160.1",\n        "10.10.20.145"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/scofield.dai/Downloads/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"scofield","spaceId":"mp-4f0f8deb-9990-4f2c-8ad9-09194f5e9be2","clientSecret":"Kk1YtuHeoRJZQQiL/ZqAmA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__83F6188";
} catch (e2) {
  ...
  !function(t2, e2) {
    ...
    var _2 = function() {
      ...
      return m3.parse = function(t3) {
        ...
        var $3, y3 = O.p(d3), M4 = w2(r3), m4 = (M4.utcOffset() - this.utcOffset()) * e2, v3 = this - M4, g3 = O.m(this, M4);
        return g3 = ($3 = {}, $3[c2] = g3 / 12, $3[f2] = g3, $3[h2] = g3 / 3, $3[o2] = (v3 - m4) / 6048e5, $3[a2] = (v3 - m4) / 864e5, $3[u2] = v3 / n2, $3[s2] = v3 / e2, $3[i2] = v3 / t2, $3)[y3] || v3, l3 ? g3 : O.a(g3);
